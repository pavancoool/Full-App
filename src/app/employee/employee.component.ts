...
export class EmployeeComponent {
  employees: any = [
    ...
    { name: 'rama', experience: 4, package: 1400000, role: 'Software Developer' },
    { name: 'smitha', experience: 1, package: 1600000, role: 'Data engineer' },
  ...
  delete(i:number){
    this.employees.splice(i,1) //delete fun
  }

  sort(){
    this.employees.sort((a:any,b:any)=>b.package-a.package);  //for sorting des order
    
  }

 /*  sortasc(){
    this.employees.sortasc((a:any,b:any)=>a.package-b.package);  //for asc sort
  } */
